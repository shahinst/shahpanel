# راه‌اندازی سرور Remnawave در vpnpanel
...
### تنظیم سرور Remnawave در vpnpanel
...
اگر توکن را در فیلد «کلید Caddy» گذاشته‌اید، بعد از به‌روزرسانی vpnpanel با ذخیرهٔ دوباره سرور خودکار به «توکن API» منتقل می‌شود.
