        ...
        <div class="panel-form-section">
            ...
            <x-form.group :label="__('servers.host')">
                <input name="host" value="{{ old('host', $server?->host) }}" required class="form-control"
                       placeholder="standard1.vpline.online" id="server-host">
            ...
            <div class="row">
                <div class="col-md-6">
                    <x-form.group :label="__('servers.ocserv_vpn_address')">
                        <input name="ocserv_vpn_address" value="{{ old('ocserv_vpn_address', $server?->ocserv_vpn_address) }}" class="form-control" dir="ltr" placeholder="ocsrv1.vpline.org">
