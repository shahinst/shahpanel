...
- بک‌آپ سرور برای **MikroTik، ثنایی (3x-ui)، Pasarguard و Remnawave** کار می‌کند. بک‌آپ ثنایی همان فایل دیتابیس SQLite خودِ پنل است که از پنل دانلود می‌شود. سرورهای Cisco و OpenConnect در این فهرست نیستند.
