...
return [
    ...
    'zarinpal' => [
        'live_base_url' => env('ZARINPAL_LIVE_BASE_URL', 'https://api.zarinpal.com/pg/v4'),
        'sandbox_base_url' => env('ZARINPAL_SANDBOX_BASE_URL', 'https://sandbox.zarinpal.com/pg/v4'),
        'live_start_pay_url' => env('ZARINPAL_LIVE_START_PAY_URL', 'https://www.zarinpal.com/pg/StartPay/'),
